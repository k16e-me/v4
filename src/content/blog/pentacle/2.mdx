...
A product charter is a single source of truth of the product, defining its goals and boundaries. While some parts of this document may be updated as the product progresses, most of it, especially its goals should ideally be almost carved in stone. This way, the product team doesn't stray.

Any change to the product's goals might actually mean a new direction, that is, a new product, entirely. Such drastic changes to the charter must be carefully weighed.
