...
2. For the sake of moving the discussion on quickly without "or's" and "/'s" (say that out loud), we call everything "product" - namely product, feature, iteration, project, service, venture, etc.
3. You might encounter the term "product commissioner" and wonder "what now, a new role?" We could've just spoken of a "product manager", no? Well, the idea of a commissioner is to not be so specific as to who may have the most emotional tie to the product, and can be the one who "commissions" it, who's in charge of it, but not necessarily the traditional role of a product manager.
