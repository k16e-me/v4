...
Pentacle introduces the concept of wireflows (a combination of user/work flows + wireframes) as a way to present the wireframes/skeletal diagramming of the product in the context of documented (user) goals. It's easier to consume and appreciate structure when you can easily visualize how it interoperates.
