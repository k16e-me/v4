...
4. This article, as with any other filed under [Workflows](/blog/workflows) only makes a presentation of "what is" and consequent interactions between client and contractor. More "how-to" materials are coming soon.
