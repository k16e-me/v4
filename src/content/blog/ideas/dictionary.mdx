...
> bubble zoom, bullhorn, business brief, entrance, entry,  fallback, front-door, gatekeeper, montage, offerings, piece, showcase, signpost, shots, slideshow, slow reveal, snapshot, tagline, topfold,
...
2. **More purpose, less literality**
    ...
    See how I discounted "slider" as not a suitable name for that kind of thing? But if you look at the dictionary you'll find "bubble zoom" (credit to [Kevin Powell](https://youtu.be/2f4JAsTFRLA?si=0ZOxaqBINBfPJoRd)). Huh? Isn't that equally specific as much, being just as literal? Yes, it is.
