...
<Callout
    ...
    padding='both'>
    bubble zoom, bullhorn, business brief, callout, countdown, entrance, entry,  fallback, front-door, gatekeeper, montage, offerings, piece, showcase, signpost, shots, slideshow, slow reveal, snapshot, tagline, topfold, tracker, wrapper
</Callout>
...
2. **More purpose, less literality**
    ...
    See how I discounted "slider" as not a suitable name for that kind of thing? But if you look at the dictionary you'll find "bubble zoom" (Credit, [Kevin Powell](https://youtu.be/2f4JAsTFRLA?si=0ZOxaqBINBfPJoRd)). Huh? Isn't that equally as specific, being just as literal? Yes, it is.
