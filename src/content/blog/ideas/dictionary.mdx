...
<Callout
    ...
    bubble zoom, bullhorn, business brief, callout, countdown, elevator pitch, entrance, entry,  fallback, front-door, gallery, gatekeeper, montage, offerings, piece, showcase, signpost, shots, slideshow, slow reveal, snapshot, tagline, topfold, tracker, wrapper
</Callout>
