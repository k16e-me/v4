...
<Callout
    ...
    bubble zoom, bullhorn, business brief, callout, colophon, countdown, elevator pitch, entrance, entry,  fallback, front-door, gallery, gatekeeper, montage, offerings, piece, rack and pinion, showcase, signpost, shots, slideshow, slow reveal, snapshot, tagline, topfold, tracker, wrapper
</Callout>
...
4. **More obvious, less clever, and the least ambiguous**
    ![“Colophon” - the very last section of a website. Source: law-firm.k16e.co](@uploads/blogs/law-firm-theme-colophon.png)
