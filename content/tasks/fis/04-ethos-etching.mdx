...
details:
    -
        title: Activities
        body: |
            - The first question to answer is, what should define the ethos of a brand? That is, what should be the basis of the brand's personality? As in, where should the brand "draw its person", so to speak?
