...
isDraft: false
region: Lagos, NG
title: Identity & Business Design for Real Estate Upstart Turnix
description: |
...
logo: turnix
cover:
    src: '@images/brands/turnix-brand-identity.png'
...
---
import cover from '@images/turnix-brand-identity.png'
