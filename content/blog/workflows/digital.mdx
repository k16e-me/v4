...
cover:
    src: '@images/workflows/workflows-digital-7-steps-cover.png'
...
---
### The Flow (7SD)
1. [Purpose, Pu](#purposepu)
2. [Journeys, Jo](#journeysjo)
3. [Structure, St](#structurest)
4. [Content, Co](#contentco)
5. [Visualizations, Vi](#visualizationsvi)
6. [Assembly, As](#assemblyas)
7. Upkeep, Up

![7SD rubric as used at K16E for making digital products such as websites, apps, SaaS (web) applications, brands, etc. Review article to see the order of application.](@images/workflows/workflows-digital-7-steps.png)
...
![7SD atomic orbital](@images/workflows/7sd-atomic-orbital.png)
...
And, finally, you assemble them, applying [good design principles](https://gdi.k16e.com/) -- concerning yourself with composition and styles that gel with content and visuals, which themselves tell a story aligning with the purpose and goals of the website.
