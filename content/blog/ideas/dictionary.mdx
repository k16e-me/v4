...
cover:
    src: '@images/blogs/possible-component-names.png'
...
4. **More obvious, less clever, and the least ambiguous**
    ![“Colophon” - "the finishing touch", closing inscriptions placed at the very bottom end of a web page. Source: law-firm.k16e.co](@images/blogs/law-firm-theme-colophon.png)
